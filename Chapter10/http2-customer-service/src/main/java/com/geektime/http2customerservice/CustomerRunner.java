package com.geektime.http2customerservice;

import com.geektime.http2customerservice.model.Coffee;
import com.geektime.http2customerservice.model.CoffeeOrder;
import com.geektime.http2customerservice.model.NewOrderRequest;
...
public class CustomerRunner implements ApplicationRunner {
    ...
    private void readMenu() {
        ...
        ResponseEntity<List<Coffee>> list = restTemplate
                .exchange(url + "/coffee/all", HttpMethod.GET, null, ptr);
